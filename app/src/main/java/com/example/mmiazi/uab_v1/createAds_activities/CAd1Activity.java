...
public class CAd1Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cad1);
        ...
        CAdStruct cad = (CAdStruct) getIntent().getSerializableExtra("cad1");
        ...
        final ImageView switchCad1 = findViewById(R.id.switchCad1);
        TextView productNameCad1 = findViewById(R.id.tv_cad1_Title);
        final RatingBar ratingBarCad1 = findViewById(R.id.ratingBar_cad1);
        final CheckBox cb_ratingBarCad1 = findViewById(R.id.cb_Rating_cad1);
        final ImageView iv_Cad1_userPhoto = findViewById(R.id.iv_cad1_photo);
        final CheckBox ctv_cad1_name = findViewById(R.id.ctv_cad1_name);
        final CheckBox ctv_cad1_reviewCheck = findViewById(R.id.ctv_cad1_reviewCheck);
        final EditText ctv_cad1_review = findViewById(R.id.ctv_cad1_review);
        final CheckBox ctv_cad1_photo = findViewById(R.id.ctv_cad1_photo);
        ...
        switchCad1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (true) {
                    ...
                    if (ctv_cad1_name.isChecked()) currentUserName = name;
                    else currentUserName = "false";

                    if (cb_ratingBarCad1.isChecked()) {
                        currentUserRating = String.valueOf(ratingBarCad1.getRating());
                    } else currentUserRating = "false";

                    if (ctv_cad1_photo.isChecked()) currentUserPhoto = userPhoto;
                    else currentUserPhoto = "false";

                    if (ctv_cad1_reviewCheck.isChecked()) {
                        currentUserComment = ctv_cad1_review.getText().toString();
...
//                    TempStruct currentUser = new TempStruct();
                    ...
                    databaseReference.child("currentUser").child("createAd1").setValue(currentUser);
    ...
    class GetImageFromURL extends AsyncTask<String, Void, Bitmap> {
        ...
        protected void onPostExecute(Bitmap bitmap) {
            ...
            ConstraintLayout constraintLayout = findViewById(R.id.back_cad1);
